...
# 🏥 Week 2 Architecture — Exposure and Data Capture  


---

# 📌 Week 2 Overview  
In Week 2, the fake healthcare IoT device is safely exposed to a controlled testing network so attacker behavior can be captured and analyzed.

The system now moves beyond just simulation and begins actively recording:
- Connection attempts  
- Brute-force attacks  
...
## 🎯 Week 2 Main Goal
Build a controlled attacker interaction environment that safely captures real attack behavior.

## 📊 Week 2 Deliverables

- ✔ Honeypot exposed
- ✔ SSH/Telnet traffic captured
- ✔ Brute-force attempts recorded
- ✔ Successful weak login tested
- ✔ Payload simulation performed
- ✔ Logs forwarded to monitoring stack
- ✔ Dashboard-ready data created
